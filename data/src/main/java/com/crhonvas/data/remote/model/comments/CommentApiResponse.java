...
public class CommentApiResponse {
    ...
    private CommentApiResponse(@NonNull Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        CommentApiResponse that = (CommentApiResponse) o;
    ...
    public static final class Builder {
        ...
        @NonNull
        public CommentApiResponse build() {
            return new CommentApiResponse(this);
        }
    }
}
